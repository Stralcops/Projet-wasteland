...
PMA_messages['strDoYouReally'] = "Voulez-vous vraiment effectuer ";
...
PMA_messages['strBLOBRepositoryDisableStrongWarning'] = "Vous allez DÉSACTIVER un dépôt BLOB !";
PMA_messages['strBLOBRepositoryDisableAreYouSure'] = "Êtes-vous certain de vouloir désactiver toutes les références BLOB pour la base sotteville-immo ?";
PMA_messages['strFormEmpty'] = "Formulaire incomplet !";
PMA_messages['strNotNumber'] = "Ce n\'est pas un nombre !";
PMA_messages['strAddIndex'] = "Ajouter Index";
PMA_messages['strEditIndex'] = "Modifier un index";
PMA_messages['strAddToIndex'] = "Ajouter %d colonne(s) à l\'index";
PMA_messages['strTotalCount'] = "Nombre total";
...
PMA_messages['strLiveTrafficChart'] = "Graphique du trafic en temps réel";
PMA_messages['strLiveConnChart'] = "Graphique des connexions et processus en temps réel";
PMA_messages['strLiveQueryChart'] = "Graphique des requêtes en temps réel";
PMA_messages['strStaticData'] = "Données statiques";
...
PMA_messages['strChartKBSent'] = "Kio transmis depuis le dernier rafraîchissement";
PMA_messages['strChartKBReceived'] = "Kio reçus depuis le dernier rafraîchissement";
PMA_messages['strChartServerTraffic'] = "Trafic du serveur (en Kio)";
PMA_messages['strChartConnections'] = "Connexions depuis le dernier rafraîchissement";
PMA_messages['strChartProcesses'] = "Processus";
PMA_messages['strChartConnectionsTitle'] = "Connexions / Processus";
PMA_messages['strChartIssuedQueries'] = "Questions depuis le dernier rafraîchissement";
PMA_messages['strChartIssuedQueriesTitle'] = "Questions (énoncés exécutés par le serveur)";
PMA_messages['strChartQueryPie'] = "Statistiques sur les requêtes";
...
PMA_messages['strQueryCacheEfficiency'] = "Efficacité de la cache de requêtes";
PMA_messages['strQueryCacheUsage'] = "Utilisation de la cache de requêtes";
PMA_messages['strQueryCacheUsed'] = "Cache de requêtes utilisée";
...
PMA_messages['strGridEditFeatureHint'] = "Vous pouvez aussi modifier la plupart des colonnes<br/> en cliquant directement sur leur contenu.";
